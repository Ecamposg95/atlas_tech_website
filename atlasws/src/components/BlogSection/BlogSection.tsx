          ...
          <div className="col-lg-4 mt-30">
            ...
            <div className="blog-btn">
              <Link className="thm-btn agency-btn" to="/blog">
                <span className="text">ver más blog</span>
                  ...
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> consejos de negocios IA
                        </li>
                        <li>
                          <img src={icon02} alt="icon" /> 24 de Marzo, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">
                          Cómo la IA está transformando las operaciones comerciales modernas e impulsando la innovación: todo lo que necesitas saber..
                        </Link>
                      </h2>
                    </div>
                  </div>
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="150ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> consejos de chatbots
                        </li>
                        <li>
                          <img src={icon02} alt="icon" /> 27 de Abril, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">Chatbots de IA vs soporte humano: ¿cuál es mejor para ti?</Link>
                      </h2>
                    </div>
                  </div>
                </div>
                ...
                <div className="xb-blog-item xb-small-blog-item wow fadeInUp" data-wow-delay="300ms" data-wow-duration="600ms">
                  <div className="xb-item--inner img-hove-effect xb-border">
                    ...
                    <div className="xb-item--holder">
                      <ul className="xb-item--meta list-unstyled ul_li">
                        <li>
                          <img src={icon01} alt="icon" /> negocios IA
                        </li>
                        <li>
                          <img src={icon02} alt="icon" /> 17 de Marzo, 2025
                        </li>
                      </ul>
                      <h2 className="xb-item--title">
                        <Link to="/blog-details">Cómo las marcas de eCommerce usan IA para aumentar las ventas..</Link>
                      </h2>
                    </div>
                  </div>
                </div>
