...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      ...
      style={{ backgroundImage: `linear-gradient(rgba(7, 7, 16, 0.95), rgba(46, 16, 101, 0.95)), url(${footerBg})` }}
    >
      <div className="xb-footer-wrap">
        {/* Footer Heading */}
        <div className="xb-footer-heading wow zoomIn" data-wow-delay="0ms" data-wow-duration="600ms">
          <h1 className="title">Atlas Tech</h1>
          <a className="mail" href="mailto:hola@atlastech.mx">
            <img src={emailIcon} alt="email" /> hola@atlastech.mx
          </a>
        </div>
        ...
        <div className="xb-footer-nav">
          ...
          <div className="xb-footer-nav-item">
            <span className="sub-title">Cómo lo hacemos</span>
            <h2 className="title">
              <Link to="/contact">Contacto</Link>
            </h2>
          </div>
          <div className="xb-footer-nav-item">
            <span className="sub-title">¿En qué somos buenos?</span>
            <h2 className="title">
              <Link to="/project">Nuestros proyectos</Link>
            </h2>
          </div>
        </div>
        ...
        <div className="xb-footer-bottom">
          <div className="contact-item">
            ...
            <span className="contact-method">Ciudad de México, México</span>
          </div>

          <div className="contact-item copyright-item">
            <p>
              Copyright © 2025 <Link to="/">Atlas Tech</Link>, Todos los derechos reservados.
            </p>
          </div>
