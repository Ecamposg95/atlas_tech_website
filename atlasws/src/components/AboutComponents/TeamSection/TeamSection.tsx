...
const teamMembers = [
  { name: "Ethan Reynolds", role: "Ingeniero de IA", img: img01 },
  { name: "Priya Ramirez", role: "Científica de Datos", img: img02 },
  { name: "Aiden Brooks", role: "Investigador de IA", img: img03 },
  { name: "Grayson Cole", role: "Arquitecto de Soluciones de IA", img: img04 },
  { name: "Eliana Rose", role: "Analista de Inteligencia", img: img05 },
  { name: "Carter Vaughn", role: "Gerente de Proyectos de IA", img: img06 },
  { name: "Logan Pierce", role: "Arquitecto de Soluciones de IA", img: img07 },
  { name: "Emerson Tate", role: "Gerente de Producto de IA", img: img08 },
];
    ...
    >
      <div className="container">
        <div className="sec-title sec-title-center text-center mb-45">
          <span className="sub-title mb-20">Nuestros Especialistas</span>
          <h2 className="title title-line_height">Profesionales dedicados</h2>
        </div>
