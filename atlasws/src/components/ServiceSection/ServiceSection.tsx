...
const services: ServiceItem[] = [
  {
    id: 1,
    title: "Producto SaaS de IA",
    desc: "Usa la IA para segmentar audiencias, personalizar campañas y analizar datos para obtener mejores resultados.",
    img: img01,
  ...
  },
  {
    ...
    desc: "Convertimos datos complejos en información clara y procesable mediante IA y analítica avanzada.",
    img: img02,
    link: "/service-details",
  },
  {
    id: 3,
    title: "Chatbot Virtual de IA",
    desc: "Creamos chatbots inteligentes que mejoran la atención al cliente y automatizan interacciones 24/7.",
    img: img03,
    link: "/service-details",
  },
  {
    ...
    desc: "Mejoramos el comercio electrónico con precios dinámicos y experiencias personalizadas.",
    img: img04,
    link: "/service-details",
  },
  {
    ...
    desc: "Guiamos a las empresas en la adopción de estrategias de IA y optimización de procesos.",
    img: img05,
    link: "/service-details",
  },
  {
    ...
    desc: "Personaliza campañas y analiza datos para un mayor compromiso y resultados.",
    img: img06,
    link: "/service-details",
  },
];
            ...
            <div className="sec-title custom-sec-title xb-sec-padding text-center">
              ...
              <div className="xb-heading-btn d-inline">
                <Link className="thm-btn agency-btn" to="/service">
                  <span className="text">ver más servicios</span>
